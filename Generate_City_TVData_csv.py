...
# are the latitude and longitude of the city of interest
...
j=0
fieldname = []
#Create a sub-csv for the city of interest (Ex: Columbus) to reduce search space for channel availability
with open('TV_TOWER_DATA.csv', 'rb') as csvfile:
    with open('Columbus_TVData_GradeB.csv', 'w') as csvoutput:
        next(csvfile)
