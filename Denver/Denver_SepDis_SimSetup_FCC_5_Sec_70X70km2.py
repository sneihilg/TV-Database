...
Data = json.load(open('GradeB_SepDis_Denver_%dkm2_Cell_TVData_70X70km2.json'%(Side_of_cell),'r'))
...
json.dump(out_channels, open('GrdB_Denver_SepDis_%dkm2_Sim_Setup_Sec_70X70km2.json'%(Side_of_cell),'w')) 


Data = json.load(open('GrdB_Denver_SepDis_%dkm2_Sim_Setup_Sec_70X70km2.json'%(Side_of_cell),'r'))
