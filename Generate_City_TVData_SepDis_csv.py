...
# Lat Long of the city of interest   
lat_S = 39.9612
long_S = -82.9988

DIS = 400       # radius of area around city
j=0
fieldname = []
#Create a sub-csv for city (Ex:Columbus) to reduce search space for channel availability
with open('Protected_Contour_Points.csv', 'rb') as csvfile:
