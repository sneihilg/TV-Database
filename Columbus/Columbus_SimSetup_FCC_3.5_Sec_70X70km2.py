...
Data = json.load(open('GradeB_Columbus_%.1fkm2Cell_Irregular_Sec70X70km2.json'%(Side_of_cell),'r'))
...
json.dump(out_channels, open('GrdB_Columbus_%.1fkm2_Sim_Setup_Sec70X70km2.json'%(Side_of_cell),'w'))           


Data = json.load(open('GrdB_Columbus_%.1fkm2_Sim_Setup_Sec70X70km2.json'%(Side_of_cell),'r'))
