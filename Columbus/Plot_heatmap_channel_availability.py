...
plt.annotate('Columbus', (p1,p2), xytext=(5, 5), textcoords='offset points',fontsize=20,weight = 'bold')
...
Data = json.load(open('GrdB_Columbus_%.1fkm2_Sim_Data_Sec_70X70km2.json'%(Side_of_cell),'r'))
...
plt.tight_layout()
plt.savefig('Heatmap_channel_availability_Cell3f5km.pdf',dpi=300,bbox_inches='tight',pad = 1)
plt.show()
